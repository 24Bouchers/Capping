...
# CREATE DATABASE #
###################
# cur.execute("ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'Que98214';")
...
ADD("E4-CB-9E-F2-8A-B3", "226.157.169.197",
    "::ffff:e29d:a9c5", "Static", "Temp")  # 1
ADD("D4-DD-66-FA-AC-D0", "176.70.83.195", "::ffff:b046:53c3", "Static", "")  # 2
ADD("ED-A1-6D-DF-53-FC", "78.85.7.67", "::ffff:4e55:743", "Default", "")  # 3
ADD("90-CC-66-F7-AD-C7", "230.42.103.155",
    "::ffff:e62a:679b", "Static", "")  # 4"
...
ADD("FD-CF-D2-DD-BE-10", "62.105.227.15",
    "::ffff:3e69:e30f", "Static", "Test")  # 8
ADD("FD-5A-DD-13-F7-30", "80.60.112.68",
    "::ffff:503c:7044", "Static", "WIP")  # 9
ADD("DB-BB-9F-28-F3-9E", "198.136.19.231",
    "::ffff:c688:13e7", "Default", "")  # 10
